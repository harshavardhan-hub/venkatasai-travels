...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.venkatasaitravels.com/blog/30-seater-medium-bus-anantapur',
  },
}

export default function ThirtySeaterBlog() {
  const faqJsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How to hire a 30 seater medium bus in Anantapur?",
        "acceptedAnswer": { "@type": "Answer", "text": "To hire a reliable 30-seater medium bus in Anantapur, call Venkata Sai Tours at 9440440969 to schedule a viewing and secure your journey immediately." }
      }
    ]
  }
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-4xl">
          <AnimatedSection>
            <nav className="flex items-center gap-2 text-sm text-cream/50 mb-8">
              ...
              <ChevronRight className="w-3 h-3" />
              <span className="text-cream/80">Medium Coach Hire</span>
            </nav>
            <div className="flex items-center gap-3 mb-6">
              <span className="text-xs font-bold text-gold uppercase tracking-widest bg-gold/10 px-3 py-1 rounded-full">30 Seaters</span>
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-cream mb-6 leading-tight">
              Hiring a <span className="text-gold">30-Seater Medium Bus</span> in Anantapur
            </h1>
            <p className="text-lg md:text-xl text-cream/80 leading-relaxed">
              When a minibus is too cramped and a luxury coach is massive overkill, the 30-seater is undeniably your best solution.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-16 bg-cream">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl space-y-10">
          <AnimatedSection className="p-6 bg-gold/10 border border-gold/30 rounded-2xl mb-8">
            <p className="font-bold text-deep-navy">📞 Searching for a 30-Seater?</p>
          ...
          <AnimatedSection>
            <h2 className="text-3xl font-serif font-bold text-deep-navy mb-4">The Golden Mean of Bus Travel</h2>
            <p className="text-deep-navy/80 leading-relaxed mb-4">
              Our 30-seater <strong>medium bus rental in Anantapur</strong> is specifically designed for roughly 20-30 individuals executing an intercity venture. Notoriously agile inside cities but firmly planted enough to conquer highway sweeps seamlessly, it represents phenomenal value. <a href="https://www.venkatasaitravels.com" className="text-gold hover:underline font-semibold">Venkata Sai Tours & Travels</a> dominates this tier locally.
            </p>
            <p className="text-deep-navy/80 leading-relaxed mb-6">
              By skipping the expensive giant frames, you decrease the overall hire toll significantly without stripping away vital features (like full AC integration and ample overhead bag space). <a href="/contact" className="text-gold hover:underline">Inquire about our medium buses directly right here.</a>
            </p>
          </AnimatedSection>

          <AnimatedSection className="bg-deep-navy text-cream p-8 rounded-3xl text-center">
            <h3 className="text-3xl font-serif font-bold mb-4">Grab Your Medium Coach Quickly</h3>
